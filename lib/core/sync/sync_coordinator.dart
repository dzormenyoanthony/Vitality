        ...
        insertLocal: (data, remoteId) => _db
            ...
            .insert(
              RemindersCompanion.insert(
                ...
                quietHoursStartMinutes: Value(data['quietHoursStartMinutes'] as int?),
                quietHoursEndMinutes: Value(data['quietHoursEndMinutes'] as int?),
                createdAt: (data['createdAt'] as Timestamp).toDate(),
                updatedAt: (data['updatedAt'] as Timestamp).toDate(),
                remoteId: Value(remoteId),
              ),
        ...
        insertLocal: (data, remoteId) => _db
            ...
            .insert(
              SavedReportsCompanion.insert(
                ...
                category: Value(data['category'] as String? ?? 'bpReport'),
                provider: Value(data['provider'] as String?),
                createdAt: (data['createdAt'] as Timestamp).toDate(),
                updatedAt: (data['updatedAt'] as Timestamp).toDate(),
                remoteId: Value(remoteId),
              ),
